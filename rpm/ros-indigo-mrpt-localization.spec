Name:           ros-indigo-mrpt-localization
Version:        0.1.14
Release:        0%{?dist}
...
%description
This package uses dynamic or static (MRPT or ROS) maps for 2D self-localization.
The interface is similar to amcl (http://wiki.ros.org/amcl) but supports
...
%changelog
* Tue Sep 20 2016 Markus Bader <markus.bader@tuwien.ac.at> - 0.1.14-0
